...
export default function Profile() {
  ...
  return (
    <Layout containerClassName="grid gap-y-3">
      ...
      Ankylosing Spondylitis (AS), and we thought it's crucial for everyone to understand what he's going through. This
      article has been put together by specialists and doctors who know their stuff, so let's dive in.
      ...
      with severe back pain, morning stiffness, and trouble catching some Zs at night. It's a real challenge, but with
      ...
      <br></br>
      <br></br>
      But Mark's no quitter! He loves reading books, gardening, and even knitting in his free time. AS might try to slow
      ...
      his joints. And let's not forget about good food, company, and some heartwarming films – these are Mark's secret
      weapons against the daily battles with AS.
      ...
      Alright, friends and family, here's where you come in. Be patient and understanding. Some days, Mark might need a
      bit of extra support. Offer to join him for a walk or swim – it's good for both his physical and mental
      well-being.
      <br></br>
      <br></br>
      And hey, don't shy away from suggesting a movie night or cooking up some tasty grub. Your company means the world
      to him, and it's these simple pleasures that make living with AS a bit easier.
      <br></br>
      <br></br>
      ...
      sprinkle of joy, individuals like Mark can continue enjoying life's little pleasures. Let's stand together, be
      there for Mark, and show AS that it's not the boss of him!
    </Layout>
  );
}
