...
const SendButtonMessage = (props: { onNewMessage: (message: String, userMessage: Boolean) => void }) => {
  ...
  const buttonStates: ButtonState[] = [
    {
      text: "If you want to get some information, push buttons",
    ...
    {
      text: "I see, you don't want to go for a walk, maybe you would like to see movie",
      buttons_text: ["yes", "no"],
    },
    {
      text: "Okay, I know some movie for you. It calls 'Garfield'",
